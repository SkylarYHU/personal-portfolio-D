#!/usr/bin/env python3
# Script to fix Heroku models.py file
...
class SocialMediaPost(models.Model):
    ...
    category = models.CharField(max_length=128, blank=True, help_text="项目分类")  # Force redeploy
...
if __name__ == '__main__':
    with open('/app/portfolioapp/models.py', 'w', encoding='utf-8') as f:
        f.write(models_content)
    print('Successfully wrote complete models.py file to Heroku')
    print('File size:', len(models_content), 'characters')